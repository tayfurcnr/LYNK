# test_receive_command_reboot.py
...
def main():
    ...
    # — REBOOT (komut ID: 0x01, parametresiz)
    payload = serialize_command(0x01)
    frame = build_mesh_frame('C', src_id=0x30, dst_id=1, payload=payload)
