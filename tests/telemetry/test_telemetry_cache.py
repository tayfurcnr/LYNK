...
def test_set_and_get_data_with_timestamp():
    src_id = 1
    data_type = "gps"
    payload = {"lat": 1.0, "lon": 2.0, "alt_m": 3.0}
...
def test_active_device_ids_detects_recent_data():
    ...
    # lynk_1 eski veri
    set_device_data(src_1, "attitude", {"roll_deg": 1})
